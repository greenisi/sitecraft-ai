...
-- WHERE table_name = 'services' AND column_name IN ('duration', 'sort_order');

-- Check products columns
-- SELECT column_name, data_type FROM information_schema.columns 
-- WHERE table_name = 'products' AND column_name IN ('inventory_count', 'sort_order');

-- Check properties columns
-- SELECT column_name, data_type FROM information_schema.columns 
-- WHERE table_name = 'properties' AND column_name IN ('sort_order', 'lot_size');
