                          ...
                          {/* Logo */}
                                  <div className="flex items-center gap-3 stagger-1">
                                              ...
                                              <div className="flex flex-col">
                                                            <span className="text-base font-bold text-white tracking-tight">SiteCraft AI</span>span>
                                                            <span className="text-[11px] text-white/40">by Innovated Marketing</span>span>
                                              </div>div>
                                  </div>div>
                                    ...
                                    {/* Feature pills */}
                                              <div className="flex flex-col gap-4">
                                                            <div className="flex items-center gap-3 text-white/60 stagger-4 group">
                                                                            ...
                                                                            <div>
                                                                                              <p className="text-sm font-medium text-white/80">Production Ready</p>p>
                                                                                              <p className="text-xs text-white/40">Deploy instantly to any platform</p>p>
                                                                            </div>div>
                                                            </div>div>
                                                            <div className="flex items-center gap-3 text-white/60 stagger-5 group">
                                                                            ...
                                                                            <div>
                                                                                              <p className="text-sm font-medium text-white/80">AI-Powered Design</p>p>
                                                                                              <p className="text-xs text-white/40">Premium templates crafted by AI</p>p>
                                                                            </div>div>
                                                            </div>div>
                                                            <div className="flex items-center gap-3 text-white/60 stagger-6 group">
                                                                            ...
                                                                            <div>
                                                                                              <p className="text-sm font-medium text-white/80">Full Stack</p>p>
                                                                                              <p className="text-xs text-white/40">Complete responsive websites with animations</p>p>
                                                                            </div>div>
                                                            </div>div>
                                              </div>div>
                                  </div>div>
                  ...
                  {/* Mobile logo */}
                        <div className="flex flex-col items-center gap-3 mb-8 lg:hidden">
                                  <Link href="/" className="flex items-center gap-2.5 group">
                                              ...
                                              <div className="flex flex-col">
                                                            <span className="text-lg font-bold tracking-tight">SiteCraft AI</span>span>
                                                            <span className="text-[10px] text-muted-foreground -mt-0.5">by Innovated Marketing</span>span>
                                              </div>div>
                                  </Link>Link>
                        </div>div>
