...
export async function POST(request: NextRequest) {
  ...
  const pipelineWithPersistence = async function* (): AsyncGenerator<GenerationEvent> {
    ...
    if (hasError) {
      ...
      // TODO: Decrement generation credits — implement RPC or direct update once credits system is finalized
      // await supabase.rpc('decrement_generation_credits', { user_id: user.id });
    }
  };
