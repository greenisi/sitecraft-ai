          ...
          <section className="py-16 px-4">
                <div className="max-w-6xl mx-auto">
                        ...
                        <div key={product.id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow group">
                                      ...
                                      <div className="p-4">
                                        {product.category && <span className="text-xs text-gray-500 uppercase">{product.category}</span>}
                                        ...
                                        {product.inventory_count === 0 && <span className="text-sm text-red-500">Out of Stock</span>}
                                      </div>
                        </div>
                      ))}
                        </div>
