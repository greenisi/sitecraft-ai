                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    .glow-border { animation: borderGlow 3s ease-in-out infinite; }
                                                                                                                                                                                                                                            .confetti-dot {
                                                                                                                                                                                                                                                      position: absolute; width: 6px; height: 6px; border-radius: 50%;
                                                                                                                                                                                                                                                                animation: confetti 1.5s ease-out both;
                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                              `}</style>style>
                      ...
                      <div className="absolute inset-0 pointer-events-none">
                        {[...Array(12)].map((_, i) => (
                                      <div
                                                        ...
                                                        style={{
                                                                            ...
                                                                            backgroundColor: ['#a855f7','#3b82f6','#22c55e','#eab308','#ef4444','#06b6d4'][i % 6],
                        ...
                        <div className="flex items-center gap-5 mb-6">
                                  <div className="relative w-24 h-24 flex-shrink-0">
                                              ...
                                              <div className="absolute inset-0 flex items-center justify-center">
                                                            <span className="text-xl font-bold text-white">{pct}%</span>span>
                                              </div>div>
                                  </div>div>
                                  ...
                                  <div>
                                              ...
                                              <p className="text-sm text-gray-400 mt-1">
                                                {allDone
                                                                  ...
                                                                  : `Complete these steps to set up your business \u2022 ${data.completedCount} of ${data.totalCount} complete`}
                                              </p>p>
                                  </div>div>
                        </div>div>
                        ...
                        <div
                                      ...
                                      <div className={`flex-1 min-w-0 ${step.completed ? 'opacity-60' : ''}`}>
                                                      ...
                                                      <p className="text-xs text-gray-500 truncate">{step.description}</p>p>
                                      </div>div>
